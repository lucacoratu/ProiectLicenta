 ...
 */
func NewConnection(l logging.ILogger) *MysqlConnection {
	return &MysqlConnection{logger: l, db: nil}
}
...
/*
 * This function will save the metrics in the database
 */
func (conn *MysqlConnection) InsertMetrics(profilingInfo data.ProfilingInformation) error {
	return nil
}
